...
namespace Reports.Presenters.UI.ViewModel
{
    ...
    public class ChangePasswordModel : IEmailDtoSupport
    {
        ...
        [Compare("NewPassword", ErrorMessage = "Поля <Новый пароль> и <Подтверждение пароля> не совпадают.")]
        public string ConfirmPassword { get; set; }

        [Required(ErrorMessageResourceName = "ChangePasswordModel_Email_Required",
        ErrorMessageResourceType = typeof(Resources))]
        [Email]
        [Display(Name = "E-mail")]
