...
{
    [PreventSpam]
    [ReportAuthorize(UserRole.OutsourcingManager | UserRole.Manager | UserRole.ConsultantPersonnel | UserRole.StaffManager | UserRole.PersonnelManager | UserRole.Security)]
