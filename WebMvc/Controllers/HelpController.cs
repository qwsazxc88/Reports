...
namespace WebMvc.Controllers
{
    ...
    public class HelpController : BaseController
    {
        ...
        [HttpGet]
        [ReportAuthorize(UserRole.OutsourcingManager | UserRole.ConsultantOutsorsingManager | UserRole.Estimator | UserRole.PersonnelManager | UserRole.ConsultantOutsourcing | UserRole.ConsultantPersonnel)]
