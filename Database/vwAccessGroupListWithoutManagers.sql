IF OBJECT_ID ('vwAccessGroupListWithoutManagers', 'V') IS NOT NULL
	DROP VIEW [dbo].[vwAccessGroupListWithoutManagers]
GO

CREATE VIEW [dbo].[vwAccessGroupListWithoutManagers]
AS
...
SELECT A.Id as UserId, A.Name as UserName, B.Name as PositionName, dep3.Name as Dep3Name, C.[Name] as Dep7Name, A.DepartmentId, D.Code as AccessGroupCode, D.Name as AccessGroupName,
			 C.Path as UserDepPath, A.Email, E.EndDate, null as Manager6, null as Manager5, null as Manager4
FROM dbo.Users as A
...
WHERE (A.RoleId & 2 > 0) and A.IsActive = 1 
