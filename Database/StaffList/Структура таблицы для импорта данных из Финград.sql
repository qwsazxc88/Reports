...
/****** Object:  Table [dbo].[Fingrag_csv]    Script Date: 27.08.2015 12:24:56 ******/
DROP TABLE [dbo].[Fingrag_csv]
GO
...
CREATE TABLE [dbo].[Fingrag_csv](
	[Код_подразделения] [nvarchar](50) NULL,
	...
	[Дата_открытия_офиса] [nvarchar](50) NULL,
	[Дата_закрытия_офиса] [nvarchar](50) NULL,
	...
	[Кол_во_запущенных_кэшинов] [nvarchar](50) NULL,
	[Дата_запуска_кэшина_первая] [nvarchar](50) NULL,
	[Инкассирующее_подразделение_кэшина] [nvarchar](250) NULL,
	[Кол_во_запущенных_банкоматов_всего] [nvarchar](50) NULL,
	[Кол_во_запущенных_банкоматов_с_функцией_кэшин] [nvarchar](50) NULL,
	[Кол_во_запущенных_банкоматов_с_функцией_ресайклинг] [nvarchar](50) NULL,
	[Дата_запуска_банкомата_первая] [nvarchar](50) NULL,
	...
	[Дни_работы_точки] [nvarchar](50) NULL,
	[Дата_начала_простоя_точки] [nvarchar](50) NULL,
	[Дата_возобновления_работы_точки] [nvarchar](50) NULL,
	...
	[Бизнес_группа_ФИО_заменяющее_РБГ_в_т_ч_для_заказа_ДС] [nvarchar](50) NULL,
