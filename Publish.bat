...
xcopy /y C:\inetpub\wwwroot\DocAppNew "C:\Users\baranov\Documents\Visual Studio 2010\Projects\test_backup\"
set now=%DATE: =0% %TIME: =0%
@echo %now% >"C:\Users\baranov\Documents\Visual Studio 2010\Projects\test\Content\lastpublish.txt"
for /d %B in ("C:\Users\baranov\Documents\Visual Studio 2010\Projects\test\*") do ( xcopy /y %B C:\inetpub\wwwroot\DocAppNew ) > copylog.txt
