...
namespace Reports.Core.Dao
{
    public class AnalyticalStatementDao :IAnalyticalStatementDao
    {
            ...
            )
        {
            ...
            if (role == UserRole.PersonnelManager)//DEPRECATED Был консультант ОК, переделано на кадровика
            {
        ...
        public string GetWhereForUserRole(UserRole role, int userId, ref string sqlQuery)
        {
            ...
            switch (role)
            {
                ...
                case UserRole.Estimator://DEPRECATED Убрал консультант ОК, добавил расчётчика
